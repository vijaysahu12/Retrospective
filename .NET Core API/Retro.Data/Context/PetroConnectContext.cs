...
namespace PetroConnect.Data.Context
{
  public partial class PetroConnectContext : DbContext
  {
    ...
    public virtual DbSet<uspRetroGet_Result> uspRetroGet { get; set; }

    public virtual DbSet<uspRetroAdd_Result> uspRetroAddorUPpdate { get; set; }
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      ...
      modelBuilder.Entity<uspRetroGet_Result>(entity =>
      {
        entity.HasNoKey();
      });
